...
class University {
    ...
    public: 
        ...
        void add(const int& option, const string& name, const string& dob, const string& school_name, string *course_name) {
            if (option == 1) list.push_back(new UniStudent(name, dob, school_name, course_name));
            else if (option == 2) list.push_back(new CollegeStudent(name, dob, school_name, course_name));
